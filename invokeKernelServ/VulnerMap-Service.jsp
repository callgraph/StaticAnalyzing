  ...
  <script type="text/javascript">
	...
	var object = document.createElement("object");		
  	...
  	function RequestWebService(){
  		var URL="http://124.16.141.130:8080/axis2/services/getVulnerMap";
  		...
  		var data;
            ...
            data = data + '<getVulMapUrl xmlns="http://impl.ws.core.serv.wuz.com"><args0>'+v+'</args0><args1>'+a+'</args1><args2>'+path0+'</args2><args3>'+path1+'</args3></getVulMapUrl>';
            data = data + '</soap12:Body>';
