  ...
  <script type="text/javascript;charset=utf-8">
	...
	function  showList(){	
  	...
  	function RequestWebService(){
  		var URL="http://124.16.141.130:8080/axis2/services/getList";  		
  		var data;  		
            var v;
            var a;
            var f;
            ...
            data = data + '<getListFileUrl xmlns="http://impl.ws.core.serv.wuz.com"><args0>'+v+'</args0><args1>'+a+'</args1><args2>'+f+'</args2><args3>'+path0+'</args3><args4>'+path1+'</args4></getListFileUrl>';
            data = data + '</soap12:Body>';
